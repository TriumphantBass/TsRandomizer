...
namespace TsRandomizer.Screens.SeedSelection
{
	class SeedOptionsCollection : InventoryRelicCollection
	{
		static readonly Dictionary<int, SeedOptionInfo> Options = new Dictionary<int, SeedOptionInfo>
		{
            ...
            { 1 << 13, new SeedOptionInfo { Name = "Damage Rando", Description = "Each orb has a high chance of having lower base damage and a low chance of having much higher base damage." } },
			{ 1 << 14, new SeedOptionInfo { Name = "Quick Pyramid", Description = "The Ancient Pyramid is accessible with only the wheel and spindle, but Sandman requires all three gears." } },
		};
