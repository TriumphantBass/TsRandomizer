...
{
	/*[TimeSpinnerType("Timespinner.GameObjects.Events.Lanterns.BaseLantern")]
	...
	[TimeSpinnerType("Timespinner.GameObjects.Events.Lanterns.CursedCaveSconceEvent")]
	...
	[TimeSpinnerType("Timespinner.GameObjects.Events.Lanterns.ForestCampfireLanternEvent")]
	...
	class Lantern : ItemManipulator<Mobile>
	{
		...
		public Lantern(Mobile typedObject, GameplayScreen gameplayScreen, ItemLocation itemLocation) 
