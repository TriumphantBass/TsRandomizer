...
namespace TsRandomizer.Randomisation
{
	class ItemLocationMap : LookupDictionary<ItemKey, ItemLocation>
	{
		...
		void AddPresentItemLocations()
		{
			...
			Add(new ItemKey(1, 2, 1016, 384), "Lake Desolation (Lower): Chicken chest", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.SandUp)), LakeDesolationLeft & R.TimeStop);
			Add(new ItemKey(1, 11, 72, 240), "Lake Desolation (Lower): Not so secret room", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.HpUp)), LakeDesolationRight & OculusRift);
			Add(new ItemKey(1, 3, 56, 176), "Lake Desolation (Upper): Tank chest", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.AuraUp)), LakeDesolationLeft & R.TimeStop);
			...
			areaName = "Library";
			Add(new ItemKey(2, 60, 328, 160), "Library: Basement", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.HpUp)), LeftLibrary);
			...
			Add(new ItemKey(2, 7, 232, 144), "Varndagroth Towers (Left): Air vents secret", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.AuraUp)), MidLibrary & OculusRift);
			Add(new ItemKey(2, 25, 328, 192), "Varndagroth Towers (Left): Elevator chest", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.SandUp)), MidLibrary & R.CardE);
			...
			Add(new ItemKey(9, 12, 280, 160), "Sealed Caves (Xarion): Secret room", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.HpUp)), SealedCaves & OculusRift);
			...
			Add(new ItemKey(9, 5, 88, 496), "Sealed Caves (Sirens): Water hook", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.SandUp)), SealedCavesSirens & R.Swimming);
			...
			Add(new ItemKey(9, 3, 744, 560), "Sealed Caves (Sirens): Siren room underwater left", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.AuraUp)), SealedCavesSirens & R.Swimming);
			...
			Add(new ItemKey(10, 3, 264, 128), "Military Fortress: Bomber chest", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.SandUp)), MilitaryFortress & DoubleJumpOfNpc & R.TimespinnerWheel); //can be reached with just upward dash but not with lightwall unless you got timestop
			Add(new ItemKey(10, 11, 296, 192), "Military Fortress: Close combat room", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.AuraUp)), MilitaryFortress);
			...
			Add(new ItemKey(10, 7, 152, 192), "Military Fortress: B door chest 1", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.SandUp)), LabEntrance & R.CardB & NeedSwimming(FloodsFlags.Lab));
			...
			Add(new ItemKey(11, 3, 1528, 192), "Lab: Lower Trash Right", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.HpUp)), MainLab & (FloodsFlags.Lab ? R.Free : R.DoubleJump));
			...
			Add(new ItemKey(11, 25, 104, 192), "Lab: Below lab entrance", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.AuraUp)), MainLab & (FloodsFlags.Lab ? R.Swimming : R.DoubleJump));
			...
			Add(new ItemKey(11, 27, 296, 160), "Lab: Lab secret", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.SandUp)), UpperLab & OculusRift);
			...
			Add(new ItemKey(12, 5, 344, 192), "Emperor's Tower: Courtyard bottom chest", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.AuraUp)), EmperorsTowerCourtyard);
			...
			Add(new ItemKey(12, 22, 56, 192), "Emperor's Tower: Galactic sage room", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.SandUp)), EmperorsTower);
			...
			Add(new ItemKey(12, 13, 120, 176), "Emperor's Tower: Left tower balcony", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.HpUp)), EmperorsTower);
		...
		void AddPastItemLocations()
		{
			...
			Add(new ItemKey(3, 15, 248, 112), "Forest: Bat jump ledge", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.AuraUp)), RefugeeCamp & (DoubleJumpOfNpc | ForwardDashDoubleJump | (R.TimeStop & R.ForwardDash)));
			Add(new ItemKey(3, 21, 120, 192), "Forest: Green platform secret", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.SandUp)), RefugeeCamp & OculusRift);
			...
			Add(new ItemKey(4, 20, 264, 160), "Castle Ramparts: In the moat", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.AuraUp)), RefugeeCamp & NeedSwimming(FloodsFlags.CastleMoat));
			Add(new ItemKey(3, 29, 248, 192), "Forest: Before Serene single bat cave", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.HpUp)), LeftSideForestCaves);
			areaName = "Upper Lake Serene";
			...
			Add(new ItemKey(7, 19, 248, 96), "Lake Serene (Upper): Double jump cave platform", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.AuraUp)), UpperLakeSirine & R.DoubleJump);
			...
			Add(new ItemKey(7, 11, 88, 240), "Lake Serene (Lower): Underwater secret", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.HpUp)), LowerLakeSirine & OculusRift);
			...
			Add(new ItemKey(7, 20, 248, 96), "Lake Serene (Lower): Past the eels", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.SandUp)), LeftSideForestCaves & R.Swimming);
			...
			Add(new ItemKey(8, 12, 280, 160), "Caves of Banishment (Maw): Secret room", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.HpUp)), CavesOfBanishmentFlooded & OculusRift);
			...
			Add(new ItemKey(8, 3, 1848, 576), "Caves of Banishment (Sirens): Siren room underwater right chest", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.AuraUp)), UpperCavesOfBanishment & R.Swimming);
			...
			Add(new ItemKey(8, 5, 88, 496), "Caves of Banishment (Sirens): Water hook", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.SandUp)), UpperCavesOfBanishment & R.Swimming);
			areaName = "Castle Ramparts";
			Add(new ItemKey(4, 1, 456, 160), "Castle Ramparts: Bomber chest", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.SandUp)), CastleRamparts & MultipleSmallJumpsOfNpc);
			Add(new ItemKey(4, 3, 136, 144), "Castle Ramparts: Freeze the engineer", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.HpUp)), CastleRamparts & (R.TimeStop | R.ForwardDash));
			...
			Add(new ItemKey(5, 45, 104, 192), "Castle Basement: Omelette chest", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.HpUp)), CastleBasement);
			Add(new ItemKey(5, 15, 296, 192), "Castle Basement: Just an egg", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.AuraUp)), CastleBasement);
			...
			Add(new ItemKey(5, 22, 312, 176), "Castle Keep: Royal guard tiny room", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.SandUp)), CastleKeep & ((R.TimeStop & R.ForwardDash) | R.DoubleJump));
			areaName = "Royal Towers";
			Add(new ItemKey(6, 19, 200, 176), "Royal Towers: Floor secret", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.AuraUp)), RoyalTower & R.DoubleJump & OculusRift);
			...
			Add(new ItemKey(6, 17, 200, 112), "Royal Towers: Top struggle juggle", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.HpUp)), UpperRoyalTower & DoubleJumpOfNpc);
			...
			Add(new ItemKey(6, 13, 120, 176), "Royal Towers: Left tower small balcony", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.SandUp)), UpperRoyalTower);
		...
		void AddPyramidItemLocations()
		{
			...
			Add(new ItemKey(16, 14, 312, 192), "Ancient Pyramid: Why not it's right there", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.SandUp)), PyramidEntrance);
			Add(new ItemKey(16, 3, 88, 192), "Ancient Pyramid: Conviction guarded room", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.HpUp)), MidPyramid);
			Add(new ItemKey(16, 22, 200, 192), "Ancient Pyramid: Pit secret room", ItemProvider.Get(CustomItem.GetIdentifier(CustomItemType.AuraUp)), MidPyramid & OculusRift & NeedSwimming(FloodsFlags.PyramidShaft));
